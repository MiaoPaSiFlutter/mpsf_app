...
/*
  精华
*/
class ItemBlogPosts extends StatefulWidget {
  ItemBlogPosts({Key key}) : super(key: key);

  @override
  _ItemBlogPostsState createState() => _ItemBlogPostsState();
}

class _ItemBlogPostsState extends State<ItemBlogPosts>
    with
          ...
          return JdHomeCell(
            ...
            callback: () {
              MpsfNavigatorUtils.pushPage(
                  context: context,
                  targetPage: JdBlogDetailScreen(initialUrl: model.url));
            },
          );
        },
